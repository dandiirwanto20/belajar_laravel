                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('mst-pangkat.destroy', $mstPangkats->id) }}" method="POST">
                                            <a class="btn btn-sm btn-primary " href="{{ route('mst-pangkat.show', $mstPangkats->id) }}"><i class="fa fa-fw fa-eye"></i> Lihat</a>
                                            <a class="btn btn-sm btn-success" href="{{ route('mst-pangkat.edit', $mstPangkats->id) }}"><i class="fa fa-fw fa-edit"></i> Ubah</a>
                                            @csrf
                                            @method('DELETE')
